class BankAccountsController < ApplicationController
  ...
  def index
    @bank_accounts = BankAccount.all.order(created_at: :desc)
  end
  ...
  private
    ...
    def bank_account_params
      params.require(:bank_account).permit(:account_title, :account_number, :iban, :balance, :bank_name, :branch_name, :branch_address, :branch_city, :user_id)
    end
end
